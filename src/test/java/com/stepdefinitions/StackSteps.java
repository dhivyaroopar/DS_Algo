...
//		DriverFactory.getDriver().get("https://dsportalapp.herokuapp.com/linked-list/deletion-in-linked-list/");
	}
...
//	@When("The user clicks the Tryhere link in Stack Page")
//	public void the_user_clicks_the_tryhere_link_in_stack_page() {
//	    stackpage.clickTryhere();
//	}
	
//	@When("The user clicks the  link in {string} for Stack module")
//	public void the_user_clicks_the_link_in_for_stack_module(String string) {
...
//	}
//
//	@When("The user click Try here link and enters the invalid code from {string} and {int} for Stack module")
//	public void the_user_click_try_here_link_and_enters_the_invalid_code_from_and_for_stack_module(String code, Integer RowNumber) throws InvalidFormatException, IOException {
//		stackpage.clickTryhere();
//		ExcelReader reader=new ExcelReader();
//		List<Map<String,String>> testData=reader.getData("src/test/resources/exceldata/Graphcode.xlsx",code);
//		String code1 = testData.get(RowNumber).get("Examples");
...
//	@When("The user clicks the \"Implementation\"for Stack module")
//	public void the_user_clicks_the_implementation_for_stack_module() {
//		 stackpage.clickimplementation();
//	}
//
//	@When("The user clicks the \"Applications\"for Stack module")
//	public void the_user_clicks_the_applications_for_stack_module() {
